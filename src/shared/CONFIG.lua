...
return {
	...
	TELEPORTATION = {
		...
		-- maximum length of time to wait before considering a group teleport a failure
		TELEPORT_ALL_TIMEOUT = 30;
		-- seconds to wait if teleportservice is flooded with calls
		FLOOD_DELAY = 15;
	};
